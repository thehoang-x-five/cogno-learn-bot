...
const roleConfig: Record<UserRole, { label: string; icon: React.ElementType; className: string }> = {
  ...
  student: { label: 'Sinh viên', icon: GraduationCap, className: 'bg-success/10 text-success border-success/20' },
};
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-5">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardDescription>Sinh viên</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex items-center gap-2">
