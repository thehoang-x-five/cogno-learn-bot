    ...
    <div className="p-8 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-muted-foreground mt-1">
            {mockCourse.semester} • {mockCourse.description}
          </p>
        </div>
        {isTeacher && (
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockCourse.studentsCount}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockCourse.documentsCount}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockCourse.quizzesCount}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardContent>
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <Button variant="outline" className="h-auto py-6 flex-col gap-2" onClick={() => setActiveTab('quizzes')}>
                  ...
                  <span className="font-medium">Làm Quiz</span>
                  <span className="text-xs text-muted-foreground">{mockQuizzes.length} quiz có sẵn</span>
                </Button>
                <Button variant="outline" className="h-auto py-6 flex-col gap-2" onClick={() => setActiveTab('documents')}>
                  <FileText className="h-8 w-8 text-warning" />
                  <span className="font-medium">Xem tài liệu</span>
                  <span className="text-xs text-muted-foreground">{mockDocuments.length} tài liệu</span>
                </Button>
              </div>
            </CardContent>
          </Card>
              ...
              <Card key={quiz.id} className="hover:shadow-md transition-shadow">
                ...
                <CardContent>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-center">
                      <p className="text-2xl font-bold text-success">{quiz.avgScore}%</p>
                      <p className="text-xs text-muted-foreground">Điểm TB</p>
                    </div>
                  </div>
                  <Button className="w-full gap-2" onClick={() => navigate('/quizzes')}>
                    <Play className="h-4 w-4" />
                    {isTeacher ? 'Xem kết quả' : 'Làm bài'}
                  </Button>
                </CardContent>
              </Card>
            ))}
              ...
              <Dialog open={isEnrollDialogOpen} onOpenChange={setIsEnrollDialogOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Nhập email sinh viên để thêm vào môn {mockCourse.name}
                    </DialogDescription>
                  </DialogHeader>
                    ...
                    <TableRow key={student.id}>
                      ...
                      <TableCell>
                        <Badge variant="outline">
                          {student.quizzesTaken}/{mockQuizzes.length}
                        </Badge>
                      </TableCell>
                      <TableCell className="text-muted-foreground">
                        {student.lastActive}
