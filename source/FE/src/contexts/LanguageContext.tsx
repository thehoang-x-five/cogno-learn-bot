...
const translations: Record<string, Record<Language, string>> = {
  ...
  'admin.dashboardLoadError': { vi: 'Không tải được thống kê. Thử lại sau.', en: 'Could not load statistics. Please try again.' },
  'admin.chartMessages': { vi: 'Tin nhắn', en: 'Messages' },
  'admin.noUserData': { vi: 'Chưa có dữ liệu người dùng', en: 'No user data yet' },
  'admin.trafficTodayDesc': { vi: 'Số tin nhắn theo giờ (UTC, hôm nay)', en: 'Messages per hour (UTC, today)' },
  'admin.healthNote': { vi: 'Chỉ kiểm tra API backend. DB, worker và LLM cần giám sát riêng.', en: 'Backend API check only. DB, workers, and LLM require separate monitoring.' },
  'admin.noRecentUsers': { vi: 'Chưa có người dùng mới', en: 'No recent users' },
  'admin.offline': { vi: 'Offline', en: 'Offline' },
  ...
  'student.noCourses': { vi: 'Chưa có môn học', en: 'No courses yet' },
  'student.noQuizData': { vi: 'Chưa có dữ liệu quiz từ hệ thống', en: 'No quiz data from the system yet' },
  'student.noExamData': { vi: 'Chưa có lịch thi trên hệ thống', en: 'No exam schedule in the system yet' },

  // Courses
  'courses.title': { vi: 'Khóa học', en: 'Courses' },
  'courses.create': { vi: 'Tạo khóa học', en: 'Add Course' },
  'courses.search': { vi: 'Tìm kiếm khóa học...', en: 'Search courses...' },
  'courses.admin.subtitle': { vi: 'Quản lý tất cả khóa học trong hệ thống', en: 'Manage all courses in the system' },
  'courses.teacher.subtitle': { vi: 'Khóa học bạn đang giảng dạy', en: 'Courses you are teaching' },
  'courses.student.subtitle': { vi: 'Các khóa học bạn đang theo học', en: 'Courses you are enrolled in' },
  'courses.all': { vi: 'Tất cả', en: 'All' },
  'courses.active': { vi: 'Đang mở', en: 'Active' },
  'courses.inactive': { vi: 'Đã đóng', en: 'Closed' },
  'courses.notFound': { vi: 'Không tìm thấy khóa học', en: 'No courses found' },
  'courses.notFoundDesc': { vi: 'Thử tìm kiếm với từ khóa khác', en: 'Try a different keyword' },
  'courses.chatAbout': { vi: 'Chat về khóa này', en: 'Chat about this course' },
  'courses.lecturer': { vi: 'Giảng viên', en: 'Lecturer' },
  'courses.docs': { vi: 'tài liệu', en: 'documents' },
  'courses.createTitle': { vi: 'Tạo khóa học mới', en: 'Create New Course' },
  'courses.createDesc': { vi: 'Thêm khóa học mới vào hệ thống', en: 'Add a new course to the system' },
  'courses.code': { vi: 'Mã khóa học', en: 'Course Code' },
  'courses.name': { vi: 'Tên khóa học', en: 'Course Name' },
  ...
  'courses.createButton': { vi: 'Tạo khóa học', en: 'Create Course' },

  // Course Detail
  'courseDetail.settings': { vi: 'Cài đặt', en: 'Settings' },
  'courseDetail.editInfo': { vi: 'Chỉnh sửa thông tin', en: 'Edit Information' },
  'courseDetail.copyCode': { vi: 'Sao chép mã khóa học', en: 'Copy Course Code' },
  'courseDetail.shareLink': { vi: 'Chia sẻ liên kết', en: 'Share Link' },
  'courseDetail.deleteCourse': { vi: 'Xóa khóa học', en: 'Delete Course' },
  ...
  'docs.selectCourseForUpload': { vi: 'Chọn một môn học trong bộ lọc để tải lên tài liệu', en: 'Select a course in the filter to upload documents' },
  'docs.noUploadPermission': { vi: 'Bạn không có quyền tải lên tài liệu cho môn học này', en: 'You do not have permission to upload documents for this course' },
  'docs.downloadError': { vi: 'Lỗi tải xuống tài liệu', en: 'Failed to download document' },
  ...
  'settings.resetReloaded': { vi: 'Đã tải lại cấu hình từ máy chủ.', en: 'Reloaded configuration from server.' },
  'settings.notConnectedTitle': { vi: 'Chưa kết nối API', en: 'Not connected to API' },
  'settings.notConnectedDesc': { vi: 'Các mục trong tab này chỉ là giao diện; chưa lưu trên máy chủ.', en: 'Items on this tab are UI-only; not persisted on the server yet.' },
  'settings.geminiOnlyTitle': { vi: 'Google Gemini', en: 'Google Gemini' },
  'settings.geminiOnlyDesc': { vi: 'Backend hiện chỉ hỗ trợ Gemini. OpenAI/Ollama sẽ bổ sung sau.', en: 'The backend currently supports Gemini only. OpenAI/Ollama may be added later.' },
  'settings.apiKeyPlaceholder': { vi: 'Dán API key từ Google AI Studio', en: 'Paste API key from Google AI Studio' },
  'settings.apiKeyPlaceholderKeep': { vi: 'Để trống để giữ key hiện tại', en: 'Leave blank to keep the current key' },
  'settings.apiKeyConfiguredHint': { vi: 'Đã cấu hình key (đuôi', en: 'Key configured (last four digits' },
  'settings.apiKeyConfiguredSuffix': { vi: ')', en: ')' },
  'settings.systemPromptOverride': { vi: 'Chỉ dùng prompt tùy chỉnh', en: 'Use custom prompt only' },
  'settings.systemPromptOverrideDesc': { vi: 'Bật: bỏ template mặc định, chỉ dùng ô bên dưới. Tắt: thêm vào template RAG.', en: 'On: replace default template with the text below. Off: append to the default RAG template.' },
  'settings.embeddingRestartHint': { vi: 'Đổi model có thể cần khởi động lại worker Celery để tải model mới.', en: 'Changing the model may require restarting the Celery worker.' },
  ...
  'breadcrumb.courses': { vi: 'Khóa học', en: 'Courses' },
